...
public abstract class DistanceSensor{
    ...
    public DistanceSensor(int slot,int channel,Model m,double lowTrigger,double highTrigger,boolean invertTriggerRange){
        this(slot,channel,m);
    ...
    public DistanceSensor(int channel,Model m,double lowTrigger,double highTrigger,boolean invertTriggerRange){
        this(1,channel,m,lowTrigger,highTrigger,invertTriggerRange);
    }
